...
class MasterQueries(BaseModel):
    market_queries: list[str] = Field(
        description="3 to 5 Google search queries focusing on market size, TAM/SAM/SOM, and industry reports."
    )
    sentiment_queries: list[str] = Field(
        description="3 to 5 Google search queries focusing on Reddit, forums, or app store reviews to find user pain points and desires."
    )
    competitor_queries: list[str] = Field(
        description="3 to 5 Google search queries focusing on direct and indirect competitors, feature comparisons, and pricing."
    )
    trend_queries: list[str] = Field(
        description="3 to 5 Google search queries focusing on Hacker News, TechCrunch, or emerging market trends and seasonality."
    )
